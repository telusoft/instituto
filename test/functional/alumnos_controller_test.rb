...
class AlumnosControllerTest < ActionController::TestCase
  ...
  test "should create alumno" do
    assert_difference('Alumno.count') do
      post :create, alumno: { apellido: @alumno.apellido, email: @alumno.email, id_curso: @alumno.id_curso, nombre: @alumno.nombre }
    end
  ...
  test "should update alumno" do
    put :update, id: @alumno, alumno: { apellido: @alumno.apellido, email: @alumno.email, id_curso: @alumno.id_curso, nombre: @alumno.nombre }
    assert_redirected_to alumno_path(assigns(:alumno))
  end
